...
The source code for the backend server (available for Node, Rails and Django) can be found in the [agent.js](https://github.com/CodyNicholson/Collective_Knowledge_Project/blob/master/src/agent.js).
...
- CRUD users (sign up & settings page) - DELETE NOT IMPLEMENTED YET
- CRUD Articles
